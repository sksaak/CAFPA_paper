...
load(['CAFPA_Elastic_dem_' num2str(c) '.mat']);
...
% save figure
if c == 2
    saveas(gcf, [path_save, 'Elastic_2\Elastic_clust_' num2str(i) '.png'])
elseif c == 3
     saveas(gcf, [path_save, 'Elastic_3\Elastic_clust_' num2str(i) '.png'])
elseif c == 4
     saveas(gcf, [path_save, 'Elastic_4\Elastic_clust_' num2str(i) '.png'])
elseif c == 5 
     saveas(gcf, [path_save, 'Elastic_5\Elastic_clust_' num2str(i) '.png'])
elseif c == 6
     saveas(gcf, [path_save, 'Elastic_6\Elastic_clust_' num2str(i) '.png'])
end 
