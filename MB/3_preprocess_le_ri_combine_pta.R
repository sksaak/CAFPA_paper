...
path_load <-  paste0("MB\\data\\MICE_imputation\\")
path_save <-  paste0("MB\\data\\le_ri_combine_pta")
...
##### add variables to data.frame #####
  ...
  # save
  save(data, file = (paste0(path_save, paste0("data_le_ri_combined_pta_", m, ".Rdata"))))
